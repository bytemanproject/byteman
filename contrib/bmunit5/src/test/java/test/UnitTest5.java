 ...
 * Copyright 2008-2019 Red Hat and individual contributors
 ...
 */
/**
 * Simple test program to exercise JUnit5 integration code
 */package test;
...
public class UnitTest5
{
    ...
    @BMScripts(
            scripts = { @BMScript(value="three", dir="src/test/scripts"),  @BMScript(value="three-extra", dir="src/test/scripts") }
    )
