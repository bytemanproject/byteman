...
https://developer.jboss.org/docs/DOC-17213[Byteman Command Line Tutorial].
...
https://developer.jboss.org/docs/DOC-52953[Byteman 
BMUnit Tutorial]. A more complex example showing the possibilities offered by BMUnit is provided in 
https://developer.jboss.org/docs/DOC-17315[Byteman Fault Injection Tutorial].
...
https://developer.jboss.org/docs/DOC-52953[Byteman 
BMUnit Tutorial]. A more complex example showing the possibilities offered by BMUnit is provided in 
https://developer.jboss.org/docs/DOC-17315[Byteman Fault Injection
Tutorial].
...
in the https://developer.jboss.org/docs/DOC-48911[Byteman Rulecheck 
Plugin Tutorial].
