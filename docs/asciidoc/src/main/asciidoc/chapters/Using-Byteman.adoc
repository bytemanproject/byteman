...
bminstall and bnjava scripts do not yet provide command flags for this
...
causes the agent toi install an access all areas security policy for the Byteman agent code. This 
