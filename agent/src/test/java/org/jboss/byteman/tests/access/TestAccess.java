...
/**
 * Test to check that access to members of non-exported classes is still possible under Jigsaw
 */
public class TestAccess extends Test
{
    ...
    public TestAccess()
    {
        super("org.jboss.byteman.tests.access.TestAccess");
    }
    ...
    public String getExpected() {
        ...
        logExpected("triggerMethod : got the unsafe!");
        logExpected("triggerMethod : got the platform loader!");
